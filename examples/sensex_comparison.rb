...
puts "╔════════════════════════════════════════════════════════════════════════════╗"
puts "║          SENSEX OPTIONS STRATEGY COMPARISON - REAL HISTORICAL DATA         ║"
puts "╚════════════════════════════════════════════════════════════════════════════╝"
...
orchestrator = Backtest::Orchestrator.new(
  ...
  output_dir: './backtest_results/sensex_comparisons'
)
...
if comparison_results.any?
  ...
  if valid_comparisons.any?
    ...
    puts "\n🏆 RECOMMENDATION: '#{best_pnl[:name]}' performed best on SENSEX."
  else
    puts "\n🏆 RECOMMENDATION: No trades were taken."
  end
else
